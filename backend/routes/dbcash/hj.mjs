...
/*Routes are named after positions at a poker table. HJ stands for Hijack.
  The Hijack position is, clockwise, before the Cutoff.
  #5 at a 9-handed table. */
...
router.get("/", async (req, res) => {
  // Access the "HJ" collection from the "dbCash" database.
  let collection = await dbCash.collection("HJ");
...
router.delete("/:id", async (req, res) => {
  ...
  let collection = dbCash.collection("HJ");
